...
export const torrentTools = [
  ...
  {
    slug: "torrent-download-time-calculator",
    kind: "calculator",
    name: "Torrent Download Time Calculator",
    icon: "⏱️",
    description: "Estimate download time from file size, connection speed, and efficiency.",
    help: "Enter the total size and your connection speed. Adjust efficiency for protocol overhead and swarm conditions. This is an estimate, not a guarantee.",
  },
  {
  ...
  {
    slug: "internet-to-torrent-speed-converter",
    kind: "calculator",
    name: "Internet to Torrent Speed Converter",
    icon: "⚡",
    description: "Convert Mbps or Gbps into expected MB/s and MiB/s download speeds.",
    help: "Internet plans use bits per second; torrent clients often show bytes per second. Eight bits equal one byte. Set an efficiency factor for an estimated usable rate.",
  },
  {
    slug: "video-file-size-reduction-estimator",
    kind: "calculator",
    name: "Video File Size Reduction Estimator",
    icon: "🎞️",
    description: "Estimate video size and savings using duration and target bitrates.",
    help: "Use your intended video and audio bitrates to estimate output size. Resolution or codec alone cannot guarantee a compression ratio. This tool estimates; it does not encode a video.",
  },
  {
  ...
  },
  {
    ...
    icon: "💾",
    description: "Plan download, extracted-file, backup, and cloud storage requirements.",
    help: "Estimate space for originals, expanded archives, backup copies, and headroom. Enter your provider’s price for an optional monthly storage estimate; bandwidth and request charges are excluded.",
  },
  {
