export const categories = [
  ...
  },
  {
    ...
    icon: "🤖",
    tools: [
      { name: "AI Image Generator", slug: "ai-image-generator", icon: "🖼️" },
      { name: "AI Text Summarizer", slug: "ai-text-summarizer", icon: "📝" },
      { name: "AI Code Generator", slug: "ai-code-generator", icon: "💻" },
    ],
  },
  {
