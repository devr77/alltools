...
export default function ShareHub() {
  ...
  return (
    <div className="share-page" style={hueStyle(["#0f766e", "#f97316"])}>
      ...
      <ToolGrid index="01" list={tools} id="all-tools" title="Pick a tool for your content" subtitle="Each tool is tuned for one kind of content, with the right formats, previews, and tips." />
